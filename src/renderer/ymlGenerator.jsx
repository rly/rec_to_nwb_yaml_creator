...
export function YMLGenerator() {
  ...
  /**
   * Opens ABOUT information in menu
   */
  useMount(() => {
  ...
  /**
   * Handles reading in a json file to serve as a base
   */
  useMount(() => {
    ...
    <>
      <div className="page-container">
        <div className="page-container__nav">
          <div className="page-container__nav--content">
        ...
        <div className="page-container__content">
          <h2 className="header-text">
            ...
            <button
              ...
              onClick={importFile}
            >
              <span className="bold" title="Import a YAML file">
                &#128194;
              </span>
            </button>
          </h2>
